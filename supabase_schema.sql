...
CREATE TABLE IF NOT EXISTS shipments (
  ...
  "Documents" TEXT,
  "Remarks" TEXT,
  "AddToMaterialCost" NUMERIC DEFAULT 1,
  "CreatedAt" TEXT
);

ALTER TABLE shipments ADD COLUMN IF NOT EXISTS "AddToMaterialCost" NUMERIC DEFAULT 1;
...
ALTER TABLE materials ADD COLUMN IF NOT EXISTS "TransportationCost" NUMERIC;
